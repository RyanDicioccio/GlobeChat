...
<!-- div to hold buttons at the top of the screen to bring user to the login or signup sheets -->
    <div class="Buttons">
    ...
    <!-- div to hold the title name and slogan. -->
    <div class="TitleName">
        <h1>GlobeChat</h1>
    ...
    <!-- div to hold all the text for the main menu page for the users info -->
    <div class="MainInfo">
